...
dict_codelists = {
    ...
    'opensafely_asthma_inhaler_steroid_medication_new': codelist_from_csv(
        'local_codelists/opensafely-asthma-inhaler-steroid-medication_new.csv',
        system='snomed',
        column='id'
        ),
    ...
    'opensafely_calcium_channel_blockers_new': codelist_from_csv(
        'local_codelists/opensafely-calcium-channel-blockers_new.csv',
        system='snomed',
        column='id'
        ),
    ...
    'opensafely_low_and_medium_dose_single_ingredient_ics_inhalers_new': codelist_from_csv(
        'local_codelists/opensafely-low-and-medium-dose-single-ingredient-ics-inhalers_new.csv',
        system='snomed',
        column='id'
        ),
    ...
    'opensafely_ibuprofen_oral_new': codelist_from_csv(
        'local_codelists/opensafely-ibuprofen-oral_new.csv',
        system='snomed',
        column='snomed_id'
        ),
    ...
    'opensafely_aspirin_new': codelist_from_csv(
        'local_codelists/opensafely-aspirin_new.csv',
        system='snomed',
        column='id'
        ),
    ...
    'opensafely_alpha_adrenoceptor_blocking_drugs_new': codelist_from_csv(
        'local_codelists/opensafely-alpha-adrenoceptor-blocking-drugs_new.csv',
        system='snomed',
        column='id'
        ),
    ...
    'opensafely_insulin_medication_new': codelist_from_csv(
        'local_codelists/opensafely-insulin-medication_new.csv',
        system='snomed',
        column='id'
        ),
    ...
    'opensafely_laba_ics_combination_inhaler_new': codelist_from_csv(
        'local_codelists/opensafely-laba-ics-combination-inhaler_new.csv',
        system='snomed',
        column='id'
        ),
    ...
    'opensafely_sama_medication_new': codelist_from_csv(
        'local_codelists/opensafely-sama-medication_new.csv',
        system='snomed',
        column='id'
        ),
    ...
    'opensafely_asthma_oral_prednisolone_medication_new': codelist_from_csv(
        'local_codelists/opensafely-asthma-oral-prednisolone-medication_new.csv',
        system='snomed',
        column='snomed_id'
        ),
    ...
    'opensafely_nsaids_oral_new': codelist_from_csv(
        'local_codelists/opensafely-nsaids-oral_new.csv',
        system='snomed',
        column='snomed_id'
        ),
    ...
    'opensafely_low_and_medium_dose_ics_inhalers_new': codelist_from_csv(
        'local_codelists/opensafely-low-and-medium-dose-ics-inhalers_new.csv',
        system='snomed',
        column='id'
        ),
    ...
    'opensafely_single_ingredient_laba_inhalers_new': codelist_from_csv(
        'local_codelists/opensafely-single-ingredient-laba-inhalers_new.csv',
        system='snomed',
        column='id'
        ),
    ...
    'opensafely_angiotensin_ii_receptor_blockers_arbs_new': codelist_from_csv(
        'local_codelists/opensafely-angiotensin-ii-receptor-blockers-arbs_new.csv',
        system='snomed',
        column='id'
        ),
    ...
    'opensafely_antiplatelets_new': codelist_from_csv(
        'local_codelists/opensafely-antiplatelets_new.csv',
        system='snomed',
        column='dmd_id'
        ),
    ...
    'opensafely_high_dose_single_ingredient_ics_inhalers_new': codelist_from_csv(
        'local_codelists/opensafely-high-dose-single-ingredient-ics-inhalers_new.csv',
        system='snomed',
        column='id'
        ),
    ...
    'opensafely_first_generation_antipsychotics_excluding_long_acting_depots_dmd_new': codelist_from_csv(
        'local_codelists/opensafely-first-generation-antipsychotics-excluding-long-acting-depots-dmd_new.csv',
        system='snomed',
        column='dmd_id'
        ),
    ...
    'opensafely_antihistamines_oral_new': codelist_from_csv(
        'local_codelists/opensafely-antihistamines-oral_new.csv',
        system='snomed',
        column='id'
        ),
    ...
    'opensafely_oestrogen_and_oestrogen_like_drugs_new': codelist_from_csv(
        'local_codelists/opensafely-oestrogen-and-oestrogen-like-drugs_new.csv',
        system='snomed',
        column='dmd_id'
        ),
    ...
    'opensafely_azithromycin_medication_new': codelist_from_csv(
        'local_codelists/opensafely-azithromycin-medication_new.csv',
        system='snomed',
        column='id'
        ),
    ...
    'opensafely_levothyroxine_new': codelist_from_csv(
        'local_codelists/opensafely-levothyroxine_new.csv',
        system='snomed',
        column='dmd_id'
        ),
    ...
    'opensafely_statin_medication_new': codelist_from_csv(
        'local_codelists/opensafely-statin-medication_new.csv',
        system='snomed',
        column='id'
        ),
    ...
    'opensafely_antidiabetic_drugs_new': codelist_from_csv(
        'local_codelists/opensafely-antidiabetic-drugs_new.csv',
        system='snomed',
        column='id'
        ),
    ...
    'opensafely_proton_pump_inhibitors_ppi_oral_new': codelist_from_csv(
        'local_codelists/opensafely-proton-pump-inhibitors-ppi-oral_new.csv',
        system='snomed',
        column='id'
        ),
    ...
    'opensafely_indometacin_new': codelist_from_csv(
        'local_codelists/opensafely-indometacin_new.csv',
        system='snomed',
        column='snomed_id'
        ),
    ...
    'opensafely_single_ingredient_ics_new': codelist_from_csv(
        'local_codelists/opensafely-single-ingredient-ics_new.csv',
        system='snomed',
        column='id'
        ),
    ...
    'opensafely_high_dose_multiple_ingredient_ics_inhalers_new': codelist_from_csv(
        'local_codelists/opensafely-high-dose-multiple-ingredient-ics-inhalers_new.csv',
        system='snomed',
        column='id'
        ),
    ...
    'opensafely_high_dose_ics_inhalers_new': codelist_from_csv(
        'local_codelists/opensafely-high-dose-ics-inhalers_new.csv',
        system='snomed',
        column='id'
        ),
    ...
    'opensafely_second_generation_antipsychotics_excluding_long_acting_injections_new': codelist_from_csv(
        'local_codelists/opensafely-second-generation-antipsychotics-excluding-long-acting-injections_new.csv',
        system='snomed',
        column='dmd_id'
        ),
    ...
    'opensafely_single_ingredient_lama_inhalers_new': codelist_from_csv(
        'local_codelists/opensafely-single-ingredient-lama-inhalers_new.csv',
        system='snomed',
        column='id'
        ),
    ...
    'opensafely_saba_inhaler_medications_new': codelist_from_csv(
        'local_codelists/opensafely-saba-inhaler-medications_new.csv',
        system='snomed',
        column='id'
        ),
    ...
    'opensafely_influenza_vaccination_new': codelist_from_csv(
        'local_codelists/opensafely-influenza-vaccination_new.csv',
        system='snomed',
        column='snomed_id'
        ),
    ...
    'opensafely_nebulised_asthma_and_copd_medications_new': codelist_from_csv(
        'local_codelists/opensafely-nebulised-asthma-and-copd-medications_new.csv',
        system='snomed',
        column='id'
        ),
    ...
    'opensafely_asthma_inhaler_salbutamol_medication_new': codelist_from_csv(
        'local_codelists/opensafely-asthma-inhaler-salbutamol-medication_new.csv',
        system='snomed',
        column='id'
        ),
    ...
    'opensafely_dmards_new': codelist_from_csv(
        'local_codelists/opensafely-dmards_new.csv',
        system='snomed',
        column='snomed_id'
        ),
    ...
    'opensafely_beta_blocker_medications_new': codelist_from_csv(
        'local_codelists/opensafely-beta-blocker-medications_new.csv',
        system='snomed',
        column='id'
        ),
    ...
    'opensafely_thiazide_type_diuretic_medication_new': codelist_from_csv(
        'local_codelists/opensafely-thiazide-type-diuretic-medication_new.csv',
        system='snomed',
        column='id'
        ),
    ...
    'opensafely_combination_blood_pressure_medication_new': codelist_from_csv(
        'local_codelists/opensafely-combination-blood-pressure-medication_new.csv',
        system='snomed',
        column='id'
        ),
    ...
    'opensafely_low_and_medium_dose_multiple_ingredient_ics_inhalers_new': codelist_from_csv(
        'local_codelists/opensafely-low-and-medium-dose-multiple-ingredient-ics-inhalers_new.csv',
        system='snomed',
        column='id'
        ),
    ...
    'opensafely_ace_inhibitor_medications_new': codelist_from_csv(
        'local_codelists/opensafely-ace-inhibitor-medications_new.csv',
        system='snomed',
        column='id'
        ),
}
